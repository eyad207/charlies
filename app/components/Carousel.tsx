...
export default function Carousel() {
  ...
  return (
    <div className='flex justify-center relative w-full h-[500px] xs:h-[400px] sm:h-[700px] md:h-[600px] lg:h-[650px] overflow-hidden bg-gradient-to-br from-black via-gray-900 to-black'>
